...
craftingTable.addShaped("cyc_eme_sword", <item:cyclic:emerald_sword>,
[[<item:minecraft:emerald>], 
[<item:minecraft:emerald>], 
[<tag:forge:rods/wooden>]]);

craftingTable.addShaped("cyc_eme_pick", <item:cyclic:emerald_pickaxe>,
...
craftingTable.addShaped("cyc_eme_shov", <item:cyclic:emerald_shovel>, 
[[<item:minecraft:emerald>], 
[<tag:forge:rods/wooden>], 
[<tag:forge:rods/wooden>]]);

craftingTable.addShapedMirrored("cyc_eme_axe", <item:cyclic:emerald_axe>,
...
craftingTable.addShapedMirrored("cyc_eme_hoe", <item:cyclic:emerald_hoe>,
[[<item:minecraft:emerald>, <item:minecraft:emerald>, <item:minecraft:air>], 
[<item:minecraft:air>, <tag:forge:rods/wooden>, <item:minecraft:air>], 
[<item:minecraft:air>, <tag:forge:rods/wooden>, <item:minecraft:air>]]);